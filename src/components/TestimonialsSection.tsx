      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((item, idx) => (
            <div 
              key={idx}
              className="bg-[#474747] border border-[#1a1a1a] p-8 md:p-11 flex flex-col justify-between rounded-none shadow-xl relative transition-transform hover:-translate-y-1 duration-200"
            >
