...
export const Hero: React.FC<HeroProps> = ({ onOpenContact, onOpenVideo }) => {
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col gap-12 lg:gap-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4 sm:gap-6 items-end w-full z-10">
            <div 
              onClick={() => onOpenVideo(`https://www.youtube-nocookie.com/embed/${heroVideoId}?autoplay=1`)}
              className="bg-[#474747] border border-white aspect-video w-full flex items-center justify-center cursor-pointer relative overflow-hidden group shadow-2xl transition-all"
            >
        ...
        <div className="pt-8 sm:pt-10 border-t border-white/10 w-full overflow-hidden">
          <div className="w-full relative overflow-hidden py-2">
            <div className="flex gap-10 sm:gap-16 items-center animate-marquee mix-blend-luminosity opacity-75 hover:opacity-100 transition-opacity">
              {[...clientLogos, ...clientLogos].map((logo, idx) => (
                <div key={idx} className="shrink-0 h-[34px] flex items-center justify-center">
